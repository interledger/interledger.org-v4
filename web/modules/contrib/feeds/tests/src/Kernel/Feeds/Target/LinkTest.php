...
class LinkTest extends FeedsKernelTestBase {
  ...
  public function testImportUrl() {
    ...
    $this->assertStringContainsString("The path 'string' is invalid.", (string) $messages[0]);
    ...
    $this->assertStringContainsString('This value should be of the correct primitive type.', (string) $messages[1]);
