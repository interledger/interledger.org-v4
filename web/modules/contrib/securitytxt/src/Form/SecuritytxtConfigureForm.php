...
class SecuritytxtConfigureForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['enabled_signature'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable the security.txt.sig line'),
      '#default_value' => $this->settings->get('enabled_signature'),
      '#description' => $this->t('When enabled, the signature line will display in the security.txt file. Leave this disabled if you are not going to create a sig file.'),
    ];
