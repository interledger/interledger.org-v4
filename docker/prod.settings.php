...
error_log("SETTINGS DEBUG: K_SERVICE=" . (getenv('K_SERVICE') ?: 'NOT_SET'));
...
if (getenv('DRUPAL_DB_HOST') || getenv('K_SERVICE')) {
  ...
  error_log("DEBUG: K_SERVICE=" . getenv('K_SERVICE'));
...
if (getenv('DRUPAL_DB_HOST')) {
  ...
  $settings['trusted_host_patterns'] = [
    ...
    '^.+\.local$',
    '^.+\.us-east1\.run\.app$',
    '^interledger-org-staging-395917053417\.us-east1\.run\.app$',
  ];
}
